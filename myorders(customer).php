...
?>  --- <?php $today="$day-$month-$day1-$year";
 ...
 echo $nextday;?></p>
           ...
           <p class="price">Rs <?php echo $price;?> <br><br><br><br><br>Subtotal Php<?php echo $price;?><br> Shipping Fee: Free<br><br></p>

           <p class="total">Total(Tax included) Rs <?php echo $price;?></p>
