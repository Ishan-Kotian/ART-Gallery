...
<body class="margn">
        ...
        <h3> Dear '.$courier_name.',</h3>
         <p>
            ...
            Note:<br><br>
            In the event that the information you provided is incomplete, a validation may be sent through phone call or SMS as part of AIY Artwork\'s order verification requirement.<br> Please be kind enough to respond if you receive either a call from 9082825902 or an SMS from sender AIY Artwork. If you do not receive any communication from us <br>your order will automatically be processed.<br><br>
